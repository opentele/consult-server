...
create table client (id  serial not null, created_date timestamp default (now()):: timestamp without time zone not null, inactive boolean, last_modified_date timestamp default (now()):: timestamp without time zone not null, uuid uuid default uuid_generate_v4() not null, date_of_birth date not null, gender varchar(100) not null, name varchar(255), registration_number varchar(100) not null, organisation_id integer not null, primary key (id));
...
create table users (id  serial not null, created_date timestamp default (now()):: timestamp without time zone not null, inactive boolean, last_modified_date timestamp default (now()):: timestamp without time zone not null, uuid uuid default uuid_generate_v4() not null, email varchar(255), mobile varchar(255), name varchar(255) not null, password varchar(255) not null, user_type varchar(255) not null, organisation_id integer not null, primary key (id));
