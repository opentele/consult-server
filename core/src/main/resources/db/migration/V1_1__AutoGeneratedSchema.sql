create table appointment (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, is_current boolean, queue_number int4 not null, created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, appointment_provider_id integer not null, client_id integer not null, consultation_id integer null, consultation_room_id integer not null, primary key (id));
create table appointment_user (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, appointment_id integer not null, user_id integer not null, primary key (id));
create table client (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, date_of_birth date not null, gender varchar(100) not null, name varchar(255), other_details varchar(1000), registration_number varchar(100), created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, primary key (id));
create table consultant_room_user (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, consultation_room_id integer not null, user_id integer not null, primary key (id));
create table consultation (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, appointment_id integer null, primary key (id));
create table consultation_room (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, scheduled_end_time time not null, scheduled_on date not null, scheduled_start_time time not null, title varchar(255) not null, total_slots int4 check (total_slots > 0), created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, consultation_room_schedule_id integer null, primary key (id));
create table consultation_room_schedule (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, end_time time not null, recurrence_rule varchar(255) not null, start_date date not null, start_time time not null, title varchar(255) not null, total_slots int4 check (total_slots > 0), created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, primary key (id));
...
create table consultation_session_record (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, complaints varchar(10000) not null, key_inference varchar(10000) not null, observations varchar(10000) not null, recommendations varchar(10000) not null, created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, client_id integer not null, consultation_room_id integer, primary key (id));
create table consultation_session_record_file (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, file_name varchar(255), mime_type varchar(255), name varchar(255), created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, consultation_session_record_id integer not null, primary key (id));
create table organisation (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, name varchar(255) not null, created_by_id int4 not null, last_modified_by_id int4 not null, primary key (id));
create table organisation_user (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, language varchar(5) not null default 'en', provider_type varchar(255) not null, user_type varchar(255) not null, created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, user_id integer not null, primary key (id));
create table password_reset_token (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, expiry_date timestamp not null, token varchar(255) not null, created_by_id int4 not null, last_modified_by_id int4 not null, user_id int4 not null, primary key (id));
create table privilege (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, name varchar(255) not null, created_by_id int4 not null, last_modified_by_id int4 not null, primary key (id));
create table role (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, name varchar(255) not null, created_by_id int4 not null, last_modified_by_id int4 not null, primary key (id));
create table role_privilege (role_id int4 not null, privilege_id int4 not null, primary key (role_id, privilege_id));
create table tele_conference (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, last_modified_date timestamp default (now()):: timestamp without time zone not null, jitsi_id varchar(255), created_by_id int4 not null, last_modified_by_id int4 not null, organisation_id integer not null, consultation_room_id integer not null, primary key (id));
create table users (id int4 generated by default as identity, inactive boolean default false not null, uuid uuid default uuid_generate_v4() not null, created_date timestamp default (now()):: timestamp without time zone not null, email varchar(255), identification varchar(255), last_modified_date timestamp default (now()):: timestamp without time zone not null, mobile varchar(255), name varchar(255) not null, password varchar(255) not null, qualification varchar(255), created_by_id int4 not null, last_modified_by_id int4 not null, primary key (id));
...
alter table if exists consultation_session_record add constraint FKhirlv1ujun01cxj0xnifgf4jd foreign key (consultation_room_id) references consultation_room;
...
alter table if exists consultation_session_record_file add constraint FKlt60weynhph3op8y4or58gtlx foreign key (consultation_session_record_id) references consultation_session_record;
